...
#define KEY_PIN_6 PORTAbits.RA3
#define KEY_PIN_5 PORTAbits.RA2
#define KEY_PIN_4 PORTBbits.RB3
#define KEY_PIN_3 PORTBbits.RB2
#define KEY_PIN_2 PORTBbits.RB1
#define KEY_PIN_1 PORTBbits.RB0
#define KEY_PIN_0 PORTEbits.RE0
