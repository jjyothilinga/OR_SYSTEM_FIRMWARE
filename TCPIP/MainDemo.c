...
static void ProcessIO(void)
{
	...
	temp = ((PORTAbits.AN3 << 7) | (PORTAbits.AN2 << 6) | (PORTBbits.RB3 << 5) | (PORTBbits.RB2 << 4) | (PORTBbits.RB1 << 3) | (PORTBbits.RB0 << 2) | (PORTEbits.RE0 << 1) | (PORTEbits.RE1));
	keyinfo = ~temp;
#if 0
